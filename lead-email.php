...
<div class="geral">
	...
	<form method="post" action="#" id="box-form-cont-bot"  name="compose" style="display:none;">
		...
		<input type="hidden" name="url_origem" value="<?php echo $urlSite.$token; ?>" />
...
$(document).ready(function() {
            ...
            $.ajax({ url: url, type: "POST", data: dados, complete: function (jqxhr){
               ...
               if(jqxhr.status === 200){
					...
					window.location.href = "https://wa.me/<?php echo $whatsAppFone; ?>?text=Estou interessado no empreendimento <?php echo $urlSite; ?>.";
